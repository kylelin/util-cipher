...
public class HomomorphicOperationTest {

    @Test
    public void testHomomorphic() {
        ...
        assertEquals(sum_m1m2.toString(), paillier.Decryption(product_em1em2).toString());
        ...
        assertEquals(prod_m1m2.toString(), paillier.Decryption(expo_em1m2).toString());
